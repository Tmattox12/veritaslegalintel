...
### Verification
- [x] Grep sweep: `app.js`, `reconData.js`, `calculations-registry.js`, `sampleData.js`, `doc-linking-integration.js` all have ZERO Template Matter/Parent A/Parent B/[Child] names
