...
const reconData = {
  "Groceries": {
    ...
    transactions: [
      ...
      {'date': '2025-09-10', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 62.50},
      {'date': '2025-09-17', 'merchant': 'WHOLE FOODS MARKET #10456', 'amount': 104.33},
      {'date': '2025-09-24', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 71.20},
      {'date': '2025-10-01', 'merchant': 'WHOLE FOODS MARKET #10456', 'amount': 91.75},
      {'date': '2025-10-08', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 68.90},
      {'date': '2025-10-15', 'merchant': 'WHOLE FOODS MARKET #10456', 'amount': 83.45},
      {'date': '2025-10-22', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 75.12},
      {'date': '2025-11-05', 'merchant': 'WHOLE FOODS MARKET #10456', 'amount': 96.33},
      {'date': '2025-11-12', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 73.88},
      {'date': '2025-11-19', 'merchant': 'WHOLE FOODS MARKET #10456', 'amount': 88.50},
      {'date': '2025-11-26', 'merchant': 'SAFEWAY #0847 PHOENIX [State]', 'amount': 79.65}
    ],
    months: 3,
  ...
  "Auto Fuel": {
    label: "Auto Fuel",
    transactions: [
      {'date': '2025-09-02', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 42.50},
      {'date': '2025-09-09', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 45.75},
      {'date': '2025-09-16', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 43.25},
      {'date': '2025-09-23', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 46.00},
      {'date': '2025-09-30', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 41.75},
      {'date': '2025-10-07', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 47.50},
      {'date': '2025-10-14', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 44.25},
      {'date': '2025-10-21', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 45.00},
      {'date': '2025-10-28', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 43.75},
      {'date': '2025-11-04', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 48.00},
      {'date': '2025-11-11', 'merchant': 'SHELL #3847 PHOENIX [State]', 'amount': 42.50},
      {'date': '2025-11-18', 'merchant': 'CHEVRON #0284 PHOENIX [State]', 'amount': 46.75}
    ],
    months: 3,
    totalTransactions: 12,
    total: 537.00,
